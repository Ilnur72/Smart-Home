export const userMessages = {
  ...
  uz: {
    ...
    failed_to_delete_user: 'Foydalanuvchini o‘chirib bo‘lmadi.',
    user_created_successfully: 'Foydalanuvchi muvaffaqiyatli yaratildi',
    user_fetched_successfully: 'Foydalanuvchi muvaffaqiyatli olindi',
  ...
  qq: {
    user_not_found: 'Paydalanıwshı tabilǵan zatdı.',
    failed_to_create_user: "Paydalanıwshı jaratıp bo'lmadi.",
    ...
    cannot_delete_user_due_to_related_records_in_other_tables:
      "Basqa kestelerdegi baylanıslı jazıwlar sebepli paydalanıwshın óshirip bo'lmadi.",
    failed_to_delete_user: "Paydalanıwshın óshirip bo'lmadi.",
    user_created_successfully: 'Paydalanıwshı múvaffaqiyatlı jaratıldı',
    user_fetched_successfully: 'Paydalanıwshı múvaffaqiyatlı alındı',
    user_updated_successfully: 'Paydalanıwshı múvaffaqiyatlı jańalandi',
    user_deleted_successfully: 'Paydalanıwshı múvaffaqiyatlı óshirildi',
  },
  ru: {
    ...
    user_fetched_successfully: 'Пользователь успешно получен',
